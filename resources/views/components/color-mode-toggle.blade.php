...
}" x-init="document.body.classList.toggle('dark', darkMode);
$watch('darkMode', value => {
    ...
    <div class="relative w-14 h-8 bg-gray-800 rounded-full peer dark:bg-orange-500 peer-checked:after:translate-x-full peer-checked:after:border-white after:absolute after:top-1 after:start-[4px] after:bg-white after:border after:rounded-full after:w-6 after:h-6 after:transition-all peer-checked:bg-orange-500">
